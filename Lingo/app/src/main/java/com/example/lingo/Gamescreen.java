...
public class Gamescreen extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] dictionary = {"abed", "abet", "able", "ably", "aced", "aces", "ache", "achy", "acid", "acne", "acre", "acts",
                ...
                "urns", "ursa", "used", "user", "uses", "utah", "vail", "vain", "vale", "vamp", "vane", "vans", "vape",
                            ...
                            if (guess.equals(s)) {
                                ...
                                if (one == first) {
                                    if (one == 'a') {
                                        ...
                                        slotImages[guesscount[0] * 4] = R.drawable.a2;
                                    } else if (one == 'b') {
                                        slotImages[0] = R.drawable.b0;
                                        slotImages[guesscount[0] * 4] = R.drawable.b2;
                                    } else if (one == 'c') {
                                        slotImages[0] = R.drawable.c0;
                                        slotImages[guesscount[0] * 4] = R.drawable.c2;
                                    } else if (one == 'd') {
                                        slotImages[0] = R.drawable.d0;
                                        slotImages[guesscount[0] * 4] = R.drawable.d2;
                                    } else if (one == 'e') {
                                        slotImages[0] = R.drawable.e0;
                                        slotImages[guesscount[0] * 4] = R.drawable.e2;
                                    } else if (one == 'f') {
                                        slotImages[0] = R.drawable.f0;
                                        slotImages[guesscount[0] * 4] = R.drawable.f2;
                                    } else if (one == 'g') {
                                        slotImages[0] = R.drawable.g0;
                                        slotImages[guesscount[0] * 4] = R.drawable.g2;
                                    } else if (one == 'h') {
                                        slotImages[0] = R.drawable.h0;
                                        slotImages[guesscount[0] * 4] = R.drawable.h2;
                                    } else if (one == 'i') {
                                        slotImages[0] = R.drawable.i0;
                                        slotImages[guesscount[0] * 4] = R.drawable.i2;
                                    } else if (one == 'j') {
                                        slotImages[0] = R.drawable.j0;
                                        slotImages[guesscount[0] * 4] = R.drawable.j2;
                                    } else if (one == 'k') {
                                        slotImages[0] = R.drawable.k0;
                                        slotImages[guesscount[0] * 4] = R.drawable.k2;
                                    } else if (one == 'l') {
                                        slotImages[0] = R.drawable.l0;
                                        slotImages[guesscount[0] * 4] = R.drawable.l2;
                                    } else if (one == 'm') {
                                        slotImages[0] = R.drawable.m0;
                                        slotImages[guesscount[0] * 4] = R.drawable.m2;
                                    } else if (one == 'n') {
                                        slotImages[0] = R.drawable.n0;
                                        slotImages[guesscount[0] * 4] = R.drawable.n2;
                                    } else if (one == 'o') {
                                        slotImages[0] = R.drawable.o0;
                                        slotImages[guesscount[0] * 4] = R.drawable.o2;
                                    } else if (one == 'p') {
                                        slotImages[0] = R.drawable.p0;
                                        slotImages[guesscount[0] * 4] = R.drawable.p2;
                                    } else if (one == 'q') {
                                        slotImages[0] = R.drawable.q0;
                                        slotImages[guesscount[0] * 4] = R.drawable.q2;
                                    } else if (one == 'r') {
                                        slotImages[0] = R.drawable.r0;
                                        slotImages[guesscount[0] * 4] = R.drawable.r2;
                                    } else if (one == 's') {
                                        slotImages[0] = R.drawable.s0;
                                        slotImages[guesscount[0] * 4] = R.drawable.s2;
                                    } else if (one == 't') {
                                        slotImages[0] = R.drawable.t0;
                                        slotImages[guesscount[0] * 4] = R.drawable.t2;
                                    } else if (one == 'u') {
                                        slotImages[0] = R.drawable.u0;
                                        slotImages[guesscount[0] * 4] = R.drawable.u2;
                                    } else if (one == 'v') {
                                        slotImages[0] = R.drawable.v0;
                                        slotImages[guesscount[0] * 4] = R.drawable.v2;
                                    } else if (one == 'w') {
                                        slotImages[0] = R.drawable.w0;
                                        slotImages[guesscount[0] * 4] = R.drawable.w2;
                                    } else if (one == 'x') {
                                        slotImages[0] = R.drawable.x0;
                                        slotImages[guesscount[0] * 4] = R.drawable.x2;
                                    } else if (one == 'y') {
                                        slotImages[0] = R.drawable.y0;
                                        slotImages[guesscount[0] * 4] = R.drawable.y2;
                                    } else if (one == 'z') {
                                        slotImages[0] = R.drawable.z0;
                                        slotImages[guesscount[0] * 4] = R.drawable.z2;
                                    }
                                } else if (first == two || first == three || first == four) {
                                    if (first == 'a') {
                                        slotImages[guesscount[0] * 4] = R.drawable.a1;
                                    } else if (first == 'b') {
                                        slotImages[guesscount[0] * 4] = R.drawable.b1;
                                    } else if (first == 'c') {
                                        slotImages[guesscount[0] * 4] = R.drawable.c1;
                                    } else if (first == 'd') {
                                        slotImages[guesscount[0] * 4] = R.drawable.d1;
                                    } else if (first == 'e') {
                                        slotImages[guesscount[0] * 4] = R.drawable.e1;
                                    } else if (first == 'f') {
                                        slotImages[guesscount[0] * 4] = R.drawable.f1;
                                    } else if (first == 'g') {
                                        slotImages[guesscount[0] * 4] = R.drawable.g1;
                                    } else if (first == 'h') {
                                        slotImages[guesscount[0] * 4] = R.drawable.h1;
                                    } else if (first == 'i') {
                                        slotImages[guesscount[0] * 4] = R.drawable.i1;
                                    } else if (first == 'j') {
                                        slotImages[guesscount[0] * 4] = R.drawable.j1;
                                    } else if (first == 'k') {
                                        slotImages[guesscount[0] * 4] = R.drawable.k1;
                                    } else if (first == 'l') {
                                        slotImages[guesscount[0] * 4] = R.drawable.l1;
                                    } else if (first == 'm') {
                                        slotImages[guesscount[0] * 4] = R.drawable.m1;
                                    } else if (first == 'n') {
                                        slotImages[guesscount[0] * 4] = R.drawable.n1;
                                    } else if (first == 'o') {
                                        slotImages[guesscount[0] * 4] = R.drawable.o1;
                                    } else if (first == 'p') {
                                        slotImages[guesscount[0] * 4] = R.drawable.p1;
                                    } else if (first == 'q') {
                                        slotImages[guesscount[0] * 4] = R.drawable.q1;
                                    } else if (first == 'r') {
                                        slotImages[guesscount[0] * 4] = R.drawable.r1;
                                    } else if (first == 's') {
                                        slotImages[guesscount[0] * 4] = R.drawable.s1;
                                    } else if (first == 't') {
                                        slotImages[guesscount[0] * 4] = R.drawable.t1;
                                    } else if (first == 'u') {
                                        slotImages[guesscount[0] * 4] = R.drawable.u1;
                                    } else if (first == 'v') {
                                        slotImages[guesscount[0] * 4] = R.drawable.v1;
                                    } else if (first == 'w') {
                                        slotImages[guesscount[0] * 4] = R.drawable.w1;
                                    } else if (first == 'x') {
                                        slotImages[guesscount[0] * 4] = R.drawable.x1;
                                    } else if (first == 'y') {
                                        slotImages[guesscount[0] * 4] = R.drawable.y1;
                                    } else if (first == 'z') {
                                        slotImages[guesscount[0] * 4] = R.drawable.z1;
                                    }
                                } else {
                                    if (first == 'a') {
                                        slotImages[guesscount[0] * 4] = R.drawable.a;
                                    } else if (first == 'b') {
                                        slotImages[guesscount[0] * 4] = R.drawable.b;
                                    } else if (first == 'c') {
                                        slotImages[guesscount[0] * 4] = R.drawable.c;
                                    } else if (first == 'd') {
                                        slotImages[guesscount[0] * 4] = R.drawable.d;
                                    } else if (first == 'e') {
                                        slotImages[guesscount[0] * 4] = R.drawable.e;
                                    } else if (first == 'f') {
                                        slotImages[guesscount[0] * 4] = R.drawable.f;
                                    } else if (first == 'g') {
                                        slotImages[guesscount[0] * 4] = R.drawable.g;
                                    } else if (first == 'h') {
                                        slotImages[guesscount[0] * 4] = R.drawable.h;
                                    } else if (first == 'i') {
                                        slotImages[guesscount[0] * 4] = R.drawable.i;
                                    } else if (first == 'j') {
                                        slotImages[guesscount[0] * 4] = R.drawable.j;
                                    } else if (first == 'k') {
                                        slotImages[guesscount[0] * 4] = R.drawable.k;
                                    } else if (first == 'l') {
                                        slotImages[guesscount[0] * 4] = R.drawable.l;
                                    } else if (first == 'm') {
                                        slotImages[guesscount[0] * 4] = R.drawable.m;
                                    } else if (first == 'n') {
                                        slotImages[guesscount[0] * 4] = R.drawable.n;
                                    } else if (first == 'o') {
                                        slotImages[guesscount[0] * 4] = R.drawable.o;
                                    } else if (first == 'p') {
                                        slotImages[guesscount[0] * 4] = R.drawable.p;
                                    } else if (first == 'q') {
                                        slotImages[guesscount[0] * 4] = R.drawable.q;
                                    } else if (first == 'r') {
                                        slotImages[guesscount[0] * 4] = R.drawable.r;
                                    } else if (first == 's') {
                                        slotImages[guesscount[0] * 4] = R.drawable.s;
                                    } else if (first == 't') {
                                        slotImages[guesscount[0] * 4] = R.drawable.t;
                                    } else if (first == 'u') {
                                        slotImages[guesscount[0] * 4] = R.drawable.u;
                                    } else if (first == 'v') {
                                        slotImages[guesscount[0] * 4] = R.drawable.v;
                                    } else if (first == 'w') {
                                        slotImages[guesscount[0] * 4] = R.drawable.w;
                                    } else if (first == 'x') {
                                        slotImages[guesscount[0] * 4] = R.drawable.x;
                                    } else if (first == 'y') {
                                        slotImages[guesscount[0] * 4] = R.drawable.y;
                                    } else if (first == 'z') {
                                        slotImages[guesscount[0] * 4] = R.drawable.z;
                                    }
                                }
                                if (two == second) {
                                    if (two == 'a') {
                                        slotImages[1] = R.drawable.a0;
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.a2;
                                    } else if (two == 'b') {
                                        slotImages[1] = R.drawable.b0;
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.b2;
                                    } else if (two == 'c') {
                                        slotImages[1] = R.drawable.c0;
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.c2;
                                    } else if (two == 'd') {
                                        slotImages[1] = R.drawable.d0;
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.d2;
                                    } else if (two == 'e') {
                                        slotImages[1] = R.drawable.e0;
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.e2;
                                    } else if (two == 'f') {
                                        slotImages[1] = R.drawable.f0;
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.f2;
                                    } else if (two == 'g') {
                                        slotImages[1] = R.drawable.g0;
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.g2;
                                    } else if (two == 'h') {
                                        slotImages[1] = R.drawable.h0;
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.h2;
                                    } else if (two == 'i') {
                                        slotImages[1] = R.drawable.i0;
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.i2;
                                    } else if (two == 'j') {
                                        slotImages[1] = R.drawable.j0;
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.j2;
                                    } else if (two == 'k') {
                                        slotImages[1] = R.drawable.k0;
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.k2;
                                    } else if (two == 'l') {
                                        slotImages[1] = R.drawable.l0;
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.l2;
                                    } else if (two == 'm') {
                                        slotImages[1] = R.drawable.m0;
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.m2;
                                    } else if (two == 'n') {
                                        slotImages[1] = R.drawable.n0;
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.n2;
                                    } else if (two == 'o') {
                                        slotImages[1] = R.drawable.o0;
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.o2;
                                    } else if (two == 'p') {
                                        slotImages[1] = R.drawable.p0;
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.p2;
                                    } else if (two == 'q') {
                                        slotImages[1] = R.drawable.q0;
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.q2;
                                    } else if (two == 'r') {
                                        slotImages[1] = R.drawable.r0;
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.r2;
                                    } else if (two == 's') {
                                        slotImages[1] = R.drawable.s0;
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.s2;
                                    } else if (two == 't') {
                                        slotImages[1] = R.drawable.t0;
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.t2;
                                    } else if (two == 'u') {
                                        slotImages[1] = R.drawable.u0;
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.u2;
                                    } else if (two == 'v') {
                                        slotImages[1] = R.drawable.v0;
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.v2;
                                    } else if (two == 'w') {
                                        slotImages[1] = R.drawable.w0;
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.w2;
                                    } else if (two == 'x') {
                                        slotImages[1] = R.drawable.x0;
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.x2;
                                    } else if (two == 'y') {
                                        slotImages[1] = R.drawable.y0;
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.y2;
                                    } else if (two == 'z') {
                                        slotImages[1] = R.drawable.z0;
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.z2;
                                    }
                                } else if (second == one || second == three || second == four) {
                                    if (second == 'a') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.a1;
                                    } else if (second == 'b') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.b1;
                                    } else if (second == 'c') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.c1;
                                    } else if (second == 'd') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.d1;
                                    } else if (second == 'e') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.e1;
                                    } else if (second == 'f') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.f1;
                                    } else if (second == 'g') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.g1;
                                    } else if (second == 'h') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.h1;
                                    } else if (second == 'i') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.i1;
                                    } else if (second == 'j') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.j1;
                                    } else if (second == 'k') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.k1;
                                    } else if (second == 'l') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.l1;
                                    } else if (second == 'm') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.m1;
                                    } else if (second == 'n') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.n1;
                                    } else if (second == 'o') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.o1;
                                    } else if (second == 'p') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.p1;
                                    } else if (second == 'q') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.q1;
                                    } else if (second == 'r') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.r1;
                                    } else if (second == 's') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.s1;
                                    } else if (second == 't') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.t1;
                                    } else if (second == 'u') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.u1;
                                    } else if (second == 'v') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.v1;
                                    } else if (second == 'w') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.w1;
                                    } else if (second == 'x') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.x1;
                                    } else if (second == 'y') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.y1;
                                    } else if (second == 'z') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.z1;
                                    }
                                } else {
                                    if (second == 'a') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.a;
                                    } else if (second == 'b') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.b;
                                    } else if (second == 'c') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.c;
                                    } else if (second == 'd') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.d;
                                    } else if (second == 'e') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.e;
                                    } else if (second == 'f') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.f;
                                    } else if (second == 'g') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.g;
                                    } else if (second == 'h') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.h;
                                    } else if (second == 'i') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.i;
                                    } else if (second == 'j') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.j;
                                    } else if (second == 'k') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.k;
                                    } else if (second == 'l') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.l;
                                    } else if (second == 'm') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.m;
                                    } else if (second == 'n') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.n;
                                    } else if (second == 'o') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.o;
                                    } else if (second == 'p') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.p;
                                    } else if (second == 'q') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.q;
                                    } else if (second == 'r') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.r;
                                    } else if (second == 's') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.s;
                                    } else if (second == 't') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.t;
                                    } else if (second == 'u') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.u;
                                    } else if (second == 'v') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.v;
                                    } else if (second == 'w') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.w;
                                    } else if (second == 'x') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.x;
                                    } else if (second == 'y') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.y;
                                    } else if (second == 'z') {
                                        slotImages[guesscount[0] * 4 + 1] = R.drawable.z;
                                    }
                                }
                                if (three == third) {
                                    if (three == 'a') {
                                        slotImages[2] = R.drawable.a0;
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.a2;
                                    } else if (three == 'b') {
                                        slotImages[2] = R.drawable.b0;
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.b2;
                                    } else if (three == 'c') {
                                        slotImages[2] = R.drawable.c0;
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.c2;
                                    } else if (three == 'd') {
                                        slotImages[2] = R.drawable.d0;
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.d2;
                                    } else if (three == 'e') {
                                        slotImages[2] = R.drawable.e0;
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.e2;
                                    } else if (three == 'f') {
                                        slotImages[2] = R.drawable.f0;
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.f2;
                                    } else if (three == 'g') {
                                        slotImages[2] = R.drawable.g0;
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.g2;
                                    } else if (three == 'h') {
                                        slotImages[2] = R.drawable.h0;
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.h2;
                                    } else if (three == 'i') {
                                        slotImages[2] = R.drawable.i0;
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.i2;
                                    } else if (three == 'j') {
                                        slotImages[2] = R.drawable.j0;
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.j2;
                                    } else if (three == 'k') {
                                        slotImages[2] = R.drawable.k0;
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.k2;
                                    } else if (three == 'l') {
                                        slotImages[2] = R.drawable.l0;
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.l2;
                                    } else if (three == 'm') {
                                        slotImages[2] = R.drawable.m0;
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.m2;
                                    } else if (three == 'n') {
                                        slotImages[2] = R.drawable.n0;
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.n2;
                                    } else if (three == 'o') {
                                        slotImages[2] = R.drawable.o0;
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.o2;
                                    } else if (three == 'p') {
                                        slotImages[2] = R.drawable.p0;
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.p2;
                                    } else if (three == 'q') {
                                        slotImages[2] = R.drawable.q0;
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.q2;
                                    } else if (three == 'r') {
                                        slotImages[2] = R.drawable.r0;
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.r2;
                                    } else if (three == 's') {
                                        slotImages[2] = R.drawable.s0;
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.s2;
                                    } else if (three == 't') {
                                        slotImages[2] = R.drawable.t0;
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.t2;
                                    } else if (three == 'u') {
                                        slotImages[2] = R.drawable.u0;
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.u2;
                                    } else if (three == 'v') {
                                        slotImages[2] = R.drawable.v0;
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.v2;
                                    } else if (three == 'w') {
                                        slotImages[2] = R.drawable.w0;
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.w2;
                                    } else if (three == 'x') {
                                        slotImages[2] = R.drawable.x0;
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.x2;
                                    } else if (three == 'y') {
                                        slotImages[2] = R.drawable.y0;
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.y2;
                                    } else if (three == 'z') {
                                        slotImages[2] = R.drawable.z0;
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.z2;
                                    }
                                } else if (third == one || third == two || third == four) {
                                    if (third == 'a') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.a1;
                                    } else if (third == 'b') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.b1;
                                    } else if (third == 'c') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.c1;
                                    } else if (third == 'd') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.d1;
                                    } else if (third == 'e') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.e1;
                                    } else if (third == 'f') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.f1;
                                    } else if (third == 'g') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.g1;
                                    } else if (third == 'h') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.h1;
                                    } else if (third == 'i') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.i1;
                                    } else if (third == 'j') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.j1;
                                    } else if (third == 'k') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.k1;
                                    } else if (third == 'l') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.l1;
                                    } else if (third == 'm') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.m1;
                                    } else if (third == 'n') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.n1;
                                    } else if (third == 'o') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.o1;
                                    } else if (third == 'p') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.p1;
                                    } else if (third == 'q') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.q1;
                                    } else if (third == 'r') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.r1;
                                    } else if (third == 's') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.s1;
                                    } else if (third == 't') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.t1;
                                    } else if (third == 'u') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.u1;
                                    } else if (third == 'v') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.v1;
                                    } else if (third == 'w') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.w1;
                                    } else if (third == 'x') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.x1;
                                    } else if (third == 'y') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.y1;
                                    } else if (third == 'z') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.z1;
                                    }
                                } else {
                                    if (third == 'a') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.a;
                                    } else if (third == 'b') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.b;
                                    } else if (third == 'c') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.c;
                                    } else if (third == 'd') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.d;
                                    } else if (third == 'e') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.e;
                                    } else if (third == 'f') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.f;
                                    } else if (third == 'g') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.g;
                                    } else if (third == 'h') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.h;
                                    } else if (third == 'i') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.i;
                                    } else if (third == 'j') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.j;
                                    } else if (third == 'k') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.k;
                                    } else if (third == 'l') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.l;
                                    } else if (third == 'm') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.m;
                                    } else if (third == 'n') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.n;
                                    } else if (third == 'o') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.o;
                                    } else if (third == 'p') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.p;
                                    } else if (third == 'q') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.q;
                                    } else if (third == 'r') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.r;
                                    } else if (third == 's') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.s;
                                    } else if (third == 't') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.t;
                                    } else if (third == 'u') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.u;
                                    } else if (third == 'v') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.v;
                                    } else if (third == 'w') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.w;
                                    } else if (third == 'x') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.x;
                                    } else if (third == 'y') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.y;
                                    } else if (third == 'z') {
                                        slotImages[guesscount[0] * 4 + 2] = R.drawable.z;
                                    }
                                }
                                if (four == fourth) {
                                    if (four == 'a') {
                                        slotImages[3] = R.drawable.a0;
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.a2;
                                    } else if (four == 'b') {
                                        slotImages[3] = R.drawable.b0;
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.b2;
                                    } else if (four == 'c') {
                                        slotImages[3] = R.drawable.c0;
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.c2;
                                    } else if (four == 'd') {
                                        slotImages[3] = R.drawable.d0;
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.d2;
                                    } else if (four == 'e') {
                                        slotImages[3] = R.drawable.e0;
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.e2;
                                    } else if (four == 'f') {
                                        slotImages[3] = R.drawable.f0;
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.f2;
                                    } else if (four == 'g') {
                                        slotImages[3] = R.drawable.g0;
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.g2;
                                    } else if (four == 'h') {
                                        slotImages[3] = R.drawable.h0;
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.h2;
                                    } else if (four == 'i') {
                                        slotImages[3] = R.drawable.i0;
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.i2;
                                    } else if (four == 'j') {
                                        slotImages[3] = R.drawable.j0;
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.j2;
                                    } else if (four == 'k') {
                                        slotImages[3] = R.drawable.k0;
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.k2;
                                    } else if (four == 'l') {
                                        slotImages[3] = R.drawable.l0;
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.l2;
                                    } else if (four == 'm') {
                                        slotImages[3] = R.drawable.m0;
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.m2;
                                    } else if (four == 'n') {
                                        slotImages[3] = R.drawable.n0;
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.n2;
                                    } else if (four == 'o') {
                                        slotImages[3] = R.drawable.o0;
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.o2;
                                    } else if (four == 'p') {
                                        slotImages[3] = R.drawable.p0;
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.p2;
                                    } else if (four == 'q') {
                                        slotImages[3] = R.drawable.q0;
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.q2;
                                    } else if (four == 'r') {
                                        slotImages[3] = R.drawable.r0;
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.r2;
                                    } else if (four == 's') {
                                        slotImages[3] = R.drawable.s0;
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.s2;
                                    } else if (four == 't') {
                                        slotImages[3] = R.drawable.t0;
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.t2;
                                    } else if (four == 'u') {
                                        slotImages[3] = R.drawable.u0;
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.u2;
                                    } else if (four == 'v') {
                                        slotImages[3] = R.drawable.v0;
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.v2;
                                    } else if (four == 'w') {
                                        slotImages[3] = R.drawable.w0;
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.w2;
                                    } else if (four == 'x') {
                                        slotImages[3] = R.drawable.x0;
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.x2;
                                    } else if (four == 'y') {
                                        slotImages[3] = R.drawable.y0;
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.y2;
                                    } else if (four == 'z') {
                                        slotImages[3] = R.drawable.z0;
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.z2;
                                    }
                                } else if (fourth == one || fourth == two || fourth == three) {
                                    if (fourth == 'a') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.a1;
                                    } else if (fourth == 'b') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.b1;
                                    } else if (fourth == 'c') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.c1;
                                    } else if (fourth == 'd') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.d1;
                                    } else if (fourth == 'e') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.e1;
                                    } else if (fourth == 'f') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.f1;
                                    } else if (fourth == 'g') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.g1;
                                    } else if (fourth == 'h') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.h1;
                                    } else if (fourth == 'i') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.i1;
                                    } else if (fourth == 'j') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.j1;
                                    } else if (fourth == 'k') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.k1;
                                    } else if (fourth == 'l') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.l1;
                                    } else if (fourth == 'm') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.m1;
                                    } else if (fourth == 'n') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.n1;
                                    } else if (fourth == 'o') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.o1;
                                    } else if (fourth == 'p') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.p1;
                                    } else if (fourth == 'q') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.q1;
                                    } else if (fourth == 'r') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.r1;
                                    } else if (fourth == 's') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.s1;
                                    } else if (fourth == 't') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.t1;
                                    } else if (fourth == 'u') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.u1;
                                    } else if (fourth == 'v') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.v1;
                                    } else if (fourth == 'w') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.w1;
                                    } else if (fourth == 'x') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.x1;
                                    } else if (fourth == 'y') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.y1;
                                    } else if (fourth == 'z') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.z1;
                                    }
                                } else {
                                    if (fourth == 'a') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.a;
                                    } else if (fourth == 'b') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.b;
                                    } else if (fourth == 'c') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.c;
                                    } else if (fourth == 'd') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.d;
                                    } else if (fourth == 'e') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.e;
                                    } else if (fourth == 'f') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.f;
                                    } else if (fourth == 'g') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.g;
                                    } else if (fourth == 'h') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.h;
                                    } else if (fourth == 'i') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.i;
                                    } else if (fourth == 'j') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.j;
                                    } else if (fourth == 'k') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.k;
                                    } else if (fourth == 'l') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.l;
                                    } else if (fourth == 'm') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.m;
                                    } else if (fourth == 'n') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.n;
                                    } else if (fourth == 'o') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.o;
                                    } else if (fourth == 'p') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.p;
                                    } else if (fourth == 'q') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.q;
                                    } else if (fourth == 'r') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.r;
                                    } else if (fourth == 's') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.s;
                                    } else if (fourth == 't') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.t;
                                    } else if (fourth == 'u') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.u;
                                    } else if (fourth == 'v') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.v;
                                    } else if (fourth == 'w') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.w;
                                    } else if (fourth == 'x') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.x;
                                    } else if (fourth == 'y') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.y;
                                    } else if (fourth == 'z') {
                                        slotImages[guesscount[0] * 4 + 3] = R.drawable.z;
                                    }
                                }
